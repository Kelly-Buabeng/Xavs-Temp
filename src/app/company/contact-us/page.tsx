      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        >
          <p className="dark:text-gray-200 text-gray-700 max-w-3xl mx-auto text-lg">
            Have questions or want to discuss a project? Reach out to our team and
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    aria-label="Facebook"
                    className="bg-gradient-to-tr from-blue-500 to-blue-700 p-3 rounded-full hover:scale-110 transition shadow-lg text-white"
                  >
                  ...
                  <a
                    href="#"
                    aria-label="Twitter"
                    className="bg-gradient-to-tr from-blue-400 to-blue-600 p-3 rounded-full hover:scale-110 transition shadow-lg text-white"
                  >
                  ...
                  <a
                    ...
                    className="bg-gradient-to-tr from-pink-500 to-yellow-400 p-3 rounded-full hover:scale-110 transition shadow-lg text-white"
                  >
                  ...
                  <a
                    href="#"
                    aria-label="YouTube"
                    className="bg-gradient-to-tr from-red-500 to-red-700 p-3 rounded-full hover:scale-110 transition shadow-lg text-white"
                  >
