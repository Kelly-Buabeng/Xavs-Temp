...
>
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    ...
    {/* Image */}
    <motion.div
      className="h-[420px] rounded-3xl overflow-hidden shadow-lg"
      style={{
    ...
    <div>
      ...
      <div className="grid sm:grid-cols-2 gap-6">
        {[
          ...
          <div
            key={i}
            className="flex items-center gap-3 bg-gray-50 dark:bg-gray-800 rounded-xl p-4 shadow-sm hover:shadow-md transition"
          >
      ...
      {/* CTA */}
      <Link href="/company/contact-us">
        <button className="mt-10 px-8 py-3 rounded-full bg-blue-600 text-white font-semibold shadow hover:bg-blue-700 transition">
          Book a Demo
        </button>
      </Link>
    </div>
